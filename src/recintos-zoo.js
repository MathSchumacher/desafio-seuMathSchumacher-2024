export class RecintosZoo {
    ...
    analisaRecintos(animal, quantidade) {
        ...
        for (const recinto of this.recintos) {
            ...
            // Calcula o espaço necessário considerando o espaço extra
    ...
    calculaEspacoExtra(animais) {
        ...
        // Calcula espaço extra se houver mais de uma espécie
        if (especies.length > 1) {
            espacoExtra = 1; // Aumenta o espaço extra necessário
        }
